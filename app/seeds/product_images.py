...
def seed_product_images():
    ...
    for product_id in range(1, 40):
        ...
        fImage = requests.get(
            f"https://picsum.photos/600/600.jpg?random={secrets.SystemRandom().randint(501,1001)}")
        ...
        image = requests.get(
            f"https://picsum.photos/600/600.jpg?random={secrets.SystemRandom().randint(1,500)}")
